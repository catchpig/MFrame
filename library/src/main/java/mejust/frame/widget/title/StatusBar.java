...
public final class StatusBar {
  ...
  public StatusBar statusBarColor(@ColorRes int statusBarColor,
    ...
    return this.statusBarColorInt(ContextCompat.getColor(Utils.getApp(), statusBarColor), alpha);
  }
  ...
  public StatusBar statusBarColorInt(@ColorInt int statusBarColor,
    ...
    immersionBar = immersionBar.statusBarColorInt(statusBarColor, statusBarColorTransform, alpha);
    return this;
  }
  ...
  public StatusBar addViewSupportTransformColor(View view, String viewColorBeforeTransform,
    ...
    return this.addViewSupportTransformColorInt(view, Color.parseColor(viewColorBeforeTransform),
  ...
  public static boolean isSupportStatusBarDarkFont() {
    return OSUtils.isMIUI6Later() || OSUtils.isFlymeOS4Later() || (Build.VERSION.SDK_INT
  ...
  public BarParams getBarParams() {
    return immersionBar.getBarParams();
  }

  public BarParams getTagBarParams(String tag) {
    return immersionBar.getTagBarParams(tag);
  }
}
